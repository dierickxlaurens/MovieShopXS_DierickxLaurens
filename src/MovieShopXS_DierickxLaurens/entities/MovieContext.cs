...
namespace MovieShopXS_DierickxLaurens.entities
{
    public partial class MovieContext : DbContext
    {
        ...
        //    optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-4CGR4B2\SQLEXPRESS;Initial Catalog=MovieBase;Integrated Security=True;");
        //}
